// Credits: https://tailwindcomponents.com/component/table-ui-with-tailwindcss-and-alpinejs
...
function dataTables() {
  ...
  function toggleColumn(key) {
    ...
    let ref = document.querySelector(`[x-ref=${key}]`);

    if (
      ref.classList.contains('hidden') &&
      ref.classList.contains(key)
    ) {
  ...
  function selectAllCheckbox(event) {
    let columns = document.querySelectorAll('.row-checkbox');
